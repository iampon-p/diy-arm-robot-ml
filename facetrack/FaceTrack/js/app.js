...
class FaceTrackApp {
    ...
    async init() {
        try {
            ...
            this.cookieDetector.init();
            
            // Auto-start cookie detection when camera is running
            document.getElementById('camera-toggle').addEventListener('click', () => {
                if (this.uiController.isCameraRunning) {
                    this.cookieDetector.startDetection();
                } else {
                    this.cookieDetector.stopDetection();
                }
            });
            
            // Set up cookie training buttons
            this.setupCookieTraining();
